...
class Pi0Faster(_model.BaseModel):
    ...
    def sample_actions(
        ...
        *,
        ...
        # NEW: the last velocity step is applied after the last freeze therefore this leaves a small residual on the prefix
        # therefore, we freeze it once more to make sure the prefix in the output chunk is actually equal to the committed prefix
        x_0 = jnp.where(prefix_action_mask[..., None], action_prefix, x_0)
        return x_0
